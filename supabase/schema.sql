...
-- For MVP: authenticated users have full access; refine later
-- ============================================================
...
-- Profiles: anyone authenticated can read all; only owner/admin can write
...
-- Other tables: authenticated full access
do $$
declare t text;
begin
